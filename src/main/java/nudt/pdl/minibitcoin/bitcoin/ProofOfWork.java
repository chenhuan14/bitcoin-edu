...
import nudt.pdl.minibitcoin.bitcoin.Peer.MiningTask;
import nudt.pdl.minibitcoin.bitcoin.common.HashUtils;

public class ProofOfWork {

    private static final byte getBit(byte ID, int position) {
//       return (byte) ((ID >> position) & (byte)1);
    	return (byte) ((ID << position) & (byte)128);
    }
